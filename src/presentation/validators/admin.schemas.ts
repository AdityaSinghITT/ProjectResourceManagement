...
import { z } from 'zod';
import { isEmployeeOrManagerRole } from '../../shared/domain/roleRules';
...
export const createUserSchema = z
  ...
  .superRefine((data, ctx) => {
    ...
    if (isEmployeeOrManagerRole(data.role)) {
      ...
      if (!data.designation) {
        ...
        ctx.addIssue({
          ...
          message: 'Designation is required for EMPLOYEE and MANAGER roles',
...
export const employeeListQuerySchema = z.object({
  ...
  status: z
    ...
    .enum([EmployeeStatus.BENCH, EmployeeStatus.ALLOCATED])
